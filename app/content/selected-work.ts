...
export const selectedWorkItems: SelectedWorkItem[] = [
  {
    ...
    stacks: ["Django", "Postgres", "AI Integration", "Next.js", "Product Engineering", "Software Architecture"],
  ...
  },
  {
    ...
    body: "Modernized an enterprication through Vue-to-Nuxt migration, GraphQL integration, real-time communication, telemetry, and administrative workflows.",
    stacks: ["Vue", "Nuxt", "Rails", "GraphQL", "AWS"],
    links: [
  ...
  },
  {
    ...
    stacks: ["WordPress", "Custom Theme", "Custom Plugin Development", "Content Production", "UI/UX"],
