...
const legacyAppModernization: ServicePageContent = {
  ...
  hero: {
    ...
    lede: "Older applications often still run important parts of a business, and the people who use and maintain them carry knowledge worth respecting. Modernization makes these systems faster, safer, and easier to change, usually in stages while they stay in production.",
  },
  problem: {
    ...
    items: [
      {
        ...
        body: "Migrating aging interfaces (jQuery, legacy Vue or React, server-rendered templates) to current frameworks one screen or module at a time, with a designer's eye for improving usability along the way.",
      },
      {
      ...
      {
        title: "Testing, performance, and observability",
        body: "Adding characterization tests around critical behavior before changing it, then finding the real bottlenecks and adding the logging, metrics, and error tracking needed to see problems before users report them.",
      },
      {
        title: "Accessibility, security, and compliance",
        body: "Bringing older interfaces up to current WCAG accessibility standards, closing security gaps left by outdated dependencies and patterns, and supporting compliance requirements such as HIPAA in regulated environments.",
      },
      {
  ...
  evidence: [
    {
      ...
      body: "I contributed to the modernization of an enterprise healthcare application, including a Vue-to-Nuxt migration, GraphQL integration, real-time communication, telemetry, and administrative workflows, all while the platform remained in active use in a regulated healthcare environment.",
      links: [{ label: "eHealth", href: "https://www.ehealthinsurance.com/" }],
    },
    {
